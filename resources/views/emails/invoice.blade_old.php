...
@php
    // TODO: QUITAR Solo para testear

    $user = App\Models\User::find(266);
	$order = App\Models\Order::find(802);
		...
		<div style="background: #eceff4;padding: 1.5rem;">
			<table>
				<tr>
					<td>
						@if($logo != null)
							<img loading="lazy"  src="https://lapieza.do/public/assets/img/logo_black.png" height="90" style="display:inline-block;">
						@else
							<img loading="lazy"  src="https://lapieza.do/public/assets/img/logo_black.png" height="90" style="display:inline-block;">
						@endif
					</td>
			...
			<table>
				...
				<tr>
					...
					<td class="text-right small"><span class="gry-color small">Fecha de entrega del producto:</span> <span class=" strong">{{ \Carbon\Carbon::parse($order->deliver_date)->locale('es')->isoFormat('D [de] MMMM [de] YYYY', 'Do MMMM YYYY') }}</span></td>
				</tr>
			</table>
		</div>
