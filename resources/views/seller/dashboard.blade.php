...
@section('panel_content')
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">Órdenes del Año</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                {{--{{ \App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count() }}--}}
                                {{ \App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->whereYear('created_at', '=', date('Y'))->count() }}
                            </h3>
                        </div>
                        <div class="col-auto text-right">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">Ventas del Año</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                @php
                                    // $orderDetails = \App\Models\OrderDetail::where('seller_id', Auth::user()->id)->get();
                                     $orderDetails = \App\Models\OrderDetail::where('seller_id', Auth::user()->id)
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none bg-soft-primary">
                <div class="card-body">
                    <div class="card-title .text-primary-pieza  fs-16 fw-600">
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                ...
                <div class="card-body">
                    ...
                    <h3 class="text-primary-pieza fw-600 fs-30">
                    ...
                    <ul class="list-group">
                        @foreach (\App\Models\Category::all() as $key => $category)
                            @if (count($category->products->where('user_id', Auth::user()->id)) > 0)
                                <li class="d-flex justify-content-between align-items-center my-2 text-primary-pieza fs-13">
            ...
            <div class="card h-450px mb-0 h-100">
                <div class="card-body">
                    <div class="card-title text-primary-pieza fs-16 fw-600">
                        {{ translate('Orders') }}
                        <p class="small text-muted mb-0">
                            <span class="fs-12 fw-600">Mes Actual</span>
                        </p>
                    </div>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary-pieza fw-600">{{ translate('Cancelled') }}</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary-pieza fw-600">{{ translate('On Delivery') }}</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                                {{--{{ OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'on_the_way')->count() }}--}}
                                {{ \App\Models\OrderDetail::where('seller_id', Auth::user()->id)
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary-pieza fw-600">{{ translate('Delivered') }}</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                    ...
                    <div class="card-body">
                        ...
                        @if (Auth::user()->shop->seller_package)
                            <div class="d-flex">
                                ...
                                <div class="col-9">
                                    <a class="fw-600 mb-3 text-primary-pieza">{{ translate('Current Package') }}:</a>
                                    <h6 class="text-primary-pieza">
                                        {{ Auth::user()->shop->seller_package->name }}
                                        </h3>
                                        <p class="mb-1 text-muted">{{ translate('Product Upload Limit') }}:
                                            {{ Auth::user()->shop->seller_package->product_upload_limit }} {{ translate('Times') }}
                                        </p>
                        ...
                        @else
                            <h6 class="fw-600 mb-3 text-primary-pieza">{{ translate('Package Not Found') }}</h6>
                        @endif
                    </div>
                </div>
            @endif
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="{{ route('seller.money_withdraw_requests.index') }}"
               class="card mb-4 p-4 text-center bg-soft-primary h-180px">
                <div class="fs-16 fw-600 text-primary-pieza">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-primary-pieza">
