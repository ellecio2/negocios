            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="{{ route('addresses.store') }}" method="POST"
                    ...
                    <div class="modal-body">
                        <input type="hidden" class="rounded-15p" name="customer_id" id="set_customer_id"
                            value="">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control mb-3 aiz-selectpicker rounded-15p" data-live-search="true"
                            ...
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="0" placeholder="{{ translate('Postal code') }}"
                                        id="postal_code" name="postal_code" class="form-control rounded-15p" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
