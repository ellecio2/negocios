                ...
                <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                  <span
                    ...
                    <div class="px-3 pt-3 pb-3">
                        <div class="h4 fw-700 text-center">{{ max(0, auth()->user()->shop->seller_package->product_upload_limit - auth()->user()->products()
    ->whereDate('created_at', '>=', \Carbon\Carbon::parse($packageInvalidDate))
    ->count()) }}</div>
                        {{--<div
                            class="h4 fw-700 text-center">{{ max(0, auth()->user()->shop->seller_package->product_upload_limit - auth()->user()->products()->count()) }}</div>--}}
            ...
            <a href="{{ route('seller.products.create')}}">
                <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                  <span
                    ...
                    <div class="fs-18 text-primary-pieza">{{ translate('Add New Product') }}</div>
                </div>
            </a>
        </div>
        @if (addon_is_activated('seller_subscription'))
