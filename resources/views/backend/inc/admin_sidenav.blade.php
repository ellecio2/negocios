    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('pos_system') &&
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('pos_configuration')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('pos.configuration.admin') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">Configuración NCF</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                                ...
                                @can('add_auction_product')
                                    <li class="aiz-side-nav-item">
                                        <a class="aiz-side-nav-link" href="{{ route('auction_product_create.admin') }}">
                                            <span
                                                class="aiz-side-nav-text text-primary-pieza">{{ translate('Add New auction product') }}</span>
                                        </a>
                                    </li>
                                @endcan
                ...
                @if (addon_is_activated('delivery_boy'))
                    @canany(['view_all_delivery_boy', 'add_delivery_boy', 'delivery_boy_payment_history',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('admin.shipping-companies.index') }}" class="aiz-side-nav-link">
                    ...
                    @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Sellers') }} y Talleres</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-2">
                                @can('view_all_seller')
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <a href="{{ route('sellers.index') }}"
                                            ...
                                            <span class="aiz-side-nav-text">{{-- translate('All Seller') --}} Todos</span>
                                            @if ($sellers > 0)
                ...
                {{-- Talleres --}}
                {{-- <li class="aiz-side-nav-item">
                    <a href="{{ route('backend.dashboard_workshop.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['backend.dashboard_workshop.index'])}}">
                        <div class="aiz-side-nav-icon"><i class="las la-paste" style="font-size:20px"></i></div>
                        <span class="aiz-side-nav-text">Talleres</span>
                    </a>
                </li> --}}
                {{-- Uploads Files --}}
                <li class="aiz-side-nav-item">
