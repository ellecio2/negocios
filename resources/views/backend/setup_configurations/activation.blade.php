...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header text-center bord-btm">
                    <h3 class="mb-0 h6 text-center">{{ __('Activación de pago Azul') }}</h3>
                </div>
                <div class="card-body">
                    <div class="clearfix">
                        <img class="float-left" src="https://www.azul.com.do/SiteAssets/v2theme/images/header/AZULLogo.png" height="30">
                        <label class="aiz-switch aiz-switch-success mb-0 float-right">
                            <input type="checkbox" onchange="updateSettings(this, 'pago_azul_payment')" <?php if (get_setting('pago_azul_payment') == 1) {
                                echo 'checked';
                            } ?>>
                            <span class="slider round"></span>
                        </label>
                    ...
                    <div class="alert text-center"
                         style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                        {{ __('Debe configurar Pago Azul correctamente para habilitar esta función') }}. <a
                            href="{{ route('payment_method.index') }}">{{ translate('Configure Now') }}</a>
                    </div>
                </div>
            </div>
