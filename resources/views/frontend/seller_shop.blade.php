...
@section('content')
    ...
    <section class="@if (!isset($type) || $type == 'top-selling' || $type == 'cupons') mb-3 @endif border-top border-bottom" style="background: #002F5C;">
        <div class="container">
            <!-- Seller Info -->
            <div class="py-4">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <!-- Ratting -->
                                <div class="rating rating-mr-1 text-white">
                                    {{ renderStarRating($shop->rating) }}
                                    <span class="fs-12">({{ $shop->num_of_reviews }}
                                        {{ translate('Reviews') }})</span>
                                </div>
                                <!-- Address -->
                                <div class="location fs-12 text-white mt-1">{{ $shop->address }}</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-lg-flex align-items-center justify-content-lg-end">
                            <div class="d-md-flex justify-content-md-end align-items-md-baseline">
                                ...
                                <div class="pr-md-3 mt-2 mt-md-0 border-md-right">
                                    <div class="fs-10 fw-400 opacity-60 text-white">{{ translate('Member Since') }}</div>
                                    <div class="mt-1 fs-16 fw-700 text-white">{{ date('d M Y', strtotime($shop->created_at)) }}</div>
                                </div>
                                <!-- Social Links -->
                                @if ($shop->facebook || $shop->instagram || $shop->google || $shop->twitter || $shop->youtube)
                                    <div class="pl-md-3 pr-lg-3 mt-2 mt-md-0 border-lg-right">
                                        <span class="fs-10 fw-400 opacity-60 text-white">{{ translate('Social Media') }}</span><br>
                            ...
                            <div class="d-flex justify-content-md-end pl-lg-3 pt-3 pt-lg-0">
                                ...
                                @else
                                    <a href="{{ route('followed_seller.store', ['id' => $shop->id]) }}"
                                        class="btn btn-primary btn-rojo d-flex align-items-center justify-content-center fs-12 w-190px follow-btn" 
                                        style="height: 40px; border-radius: 30px !important; justify-content: center;">
