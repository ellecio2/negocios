@if ($detailedProduct->added_by == 'seller' && $detailedProduct->user->shop != null)
    <div class="border mb-4 br-banner" style="background: #003b73;">
        <div class="position-relative p-3 p-sm-4 text-white">
            ...
            <div class="mt-3">
                <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                    class="btn btn-block btn-ask1 fs-14 fw-700 rounded-25px">{{ translate('Visit Store') }}</a>
            </div>
        </div>
    </div>
@endif
