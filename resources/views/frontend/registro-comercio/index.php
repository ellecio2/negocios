...
<body>
  ...
  <div class="page_wrapper">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12"  data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="banner_text">
              ...
              <h1> Bienvenido a <br><span style="color: black;">La Pieza.<span style="color: #E63108;">DO</span></span></h1>
              <!-- p -->
              <p style="color: black;"><span style="color: #003b73;">Compra, factura, organiza tu inventario y recibe pagos en línea.</span>Tenemos las herramientas para que tu negocio crezca.
              </p>
            </div>

            <div class="trial_box">
              <!-- form -->
              <form action="registro-form/register.php" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="100">
                  <!-- <div class="form-group">
                      <input type="email" class="form-control" placeholder="Enter your email">
                  </div> -->
                  <div class="form-group">
                      <button class="btn" >COMIENZA AQUI!</button>
                  </div>
              </form>
          </div>
          ...
          <div class="col-lg-3 col-md-6"  data-aos="fade-in" data-aos-duration="1500">
            <div class="banner_images image_box1">
                <span class="banner_image1"> <img class="moving_position_animatin" src="images/bannerimage1.png" alt="image" > </span>
                <span class="banner_image2"> <img class="moving_animation" src="images/bannerimage2.png" alt="image" > </span>
            </div>
          </div>
    ...
    <section class="row_am features_section" id="features">
      <!-- section bg -->
      <div class="feature_section_bg"> <img src="images/hero-red-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
        <div class="features_inner">
          ...
          <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
            <!-- h2 -->
            <h2 style="color:#003b73"><span style="color: black;">Lo</span style="color: #003b73;"> que hace de <span style="color: black;">La Pieza.<span style="color: #E63108;">DO</span></span><br> una opción única!</h2>
            <!-- p -->
            <p>Maneja tu inventario, recibe pagos, factura y vende en linea<br> de la manera segura y efectiva.</p>
          </div>
            ...
            <div class="col-md-3">
                <div class="feature_box" data-aos="fade-up" data-aos-duration="1900">
                    ...
                    <div class="text">
                      ...
                      <p>Para conocer el comportamiento de compra de tus clientes y ofrecerles lo mejor.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="row_am modern_ui_section">
      <!-- section bg -->
      <div class="modernui_section_bg"> <img src="images/hero-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
      	<!-- row start -->
        <div class="row">
            ...
            <div class="ui_text">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Fácil Acceso</h4>
                  <p>Solo tienes que poner tu email, teléfono, facebook o instagram, tu contraseña y ¡listo!.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Sincronice con su sistema en la computadora</h4>
                  <p>Cuando estés en línea, todo se sincroniza en tu computadora, para que puedas acceder a tu negocio desde cualquier lugar.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Tu inventario a la mano</h4>
                  <p>Tenemos la gestión de inventario para ti desde tu móvil o computadora, todo con un solo clic.</p>
                </li>
              </ul>
            </div>
          </div>
    ...
    <section class="row_am how_it_works" id="how_it_work">
      <!-- section bg -->
      <div class="how_section_bg"> <img src="images/hero-red-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
        <div class="how_it_inner">
          <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
          	<!-- h2 -->
            <h2><span style="color: #003b73">Cómo funciona <span style="color: black;">La Pieza.<span style="color: #E63108;">DO</span></span> en 3 sencillos pasos</h2>
            <!-- p -->
            <p>Usar <span style="color: black;">La Pieza.<span style="color: #E63108;">DO</span> es súper fácil, solo sigue estos pasos.</p>
          </div>
            ...
            <ul>
              ...
              <li>
                <div class="step_text" data-aos="fade-left" data-aos-duration="1500">
                  ...
                  <p>Inicia sesión en la aplicación o en tu computadora. Una cuenta para todos los dispositivos.</p>
                </div>
    ...
    <section class="row_am faq_section">
      <!-- section bg -->
      <div class="faq_bg"> <img src="images/hero-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
        <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
          <!-- h2 -->
          ...
          <!-- p -->
          <p>Aqui tenemos todas las respuestas a tus preguntas con respecto al uso de <span style="color: black;">La Pieza.<span style="color: #E63108;">DO</span></span>. Aquí podrás encontrar respuestas rápidas para que puedas utilizar la aplicación.</p>
        </div>
        <!-- faq data -->
        <div class="faq_panel">
          <div class="accordion" id="accordionExample">
              ...
              <div class="card-header" id="headingOne">
                <h2 class="mb-0">
                  <button type="button" class="btn btn-link active" data-toggle="collapse" data-target="#collapseOne">
                  	<i class="icon_faq icofont-plus"></i></i> Cómo puedo subir mi inventario?</button>
                </h2>
              </div>
              ...
              <div class="card-header" id="headingTwo">
                <h2 class="mb-0">
                  <button type="button" class="btn btn-link collapsed" data-toggle="collapse"
                    data-target="#collapseTwo"><i class="icon_faq icofont-plus"></i></i> Cómo configuro mi cuenta ?</button>
                </h2>
              </div>
            ...
            <div class="card" data-aos="fade-up" data-aos-duration="1500">
              <div class="card-header" id="headingThree">
                <h2 class="mb-0">
                  <button type="button" class="btn btn-link collapsed" data-toggle="collapse"
                    data-target="#collapseThree"><i class="icon_faq icofont-plus"></i></i>Cuál es el proceso para solicitar un reembolso
                    ?</button>
                </h2>
              </div>
            ...
            <div class="card" data-aos="fade-up" data-aos-duration="1500">
              <div class="card-header" id="headingFour">
                <h2 class="mb-0">
                  <button type="button" class="btn btn-link collapsed" data-toggle="collapse"
                    data-target="#collapseFour"><i class="icon_faq icofont-plus"></i></i>Como registro mis productos
                    ?</button>
                </h2>
              </div>
                    ...
                    <div class="col-md-6">
                        <div class="free_text">
                            <div class="section_title">
                                ...
                                <p>Descarga nuestra app y sácale provecho a tu negocio en línea. Registrate y descubre lo nuevo que tenemos para ti.</p>
                            </div>
                            <ul class="app_btn">
                              <li>
                                <a href="#">
