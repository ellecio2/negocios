          ...
          <div class="row">
            <div class="col-lg-7 offset-lg-5 p-sm-0">
              <div class="ugf-content pt150">
                ...
                <p>Escribe tus informaciones y una contraseña segura para continuar al siguiente paso.</p>
                <form action="personal-payments.php" class="account-form">
                  <div class="row">
                    <div class="col-sm-6 p-sm-0">
                      <div class="form-group">
                        <label for="inputFname">Nombres</label>
                        <input type="text" placeholder="ej. Juan" class="form-control" id="inputFname">
                      </div>
                    </div>
                    <div class="col-sm-6 p-sm-0">
                      <div class="form-group">
                        <label for="inputLname">Apellidos</label>
                        <input type="text" placeholder="ej. Pérez" class="form-control" id="inputLname">
                      </div>
                    </div>
