<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
            href="{{ static_asset('assets/registrocomercio/registro-form/assets/css/theme-3.css') }}">
                                    ...
                                    <div class="container">
                                        <div class="form-row col-md-9">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="name_user" name="name_user" id="name_user" placeholder="Nombre y Apellio" class="form-control name_user @error('name_user') is-invalid @enderror" value="{{ old('name_user') }}">
                                            ...
                                            <h5 style="padding-bottom: 2%; padding-top: 7%;">Datos del taller</h5>
                                            <div class="border border-vertical mb-4"></div>
