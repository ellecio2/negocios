<div class="aiz-user-sidenav-wrap position-relative z-1 rounded-15p gry-bg">
                 ...
                 <!-- My Articles -->
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{ route('articles.index') }}"
                            ...
                            class="aiz-side-nav-link {{ areActiveRoutes(['articles.index']) }}">

                            <svg id="car-icon" data-name="car-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 16 18">

                            <defs>

                                <clipPath id="clip-path">

                                    <rect id="Rectangle_1386" data-name="Rectangle 1386" width="16" height="18" fill="#b5b5bf" />
                            ...
                            <span class="aiz-side-nav-text ml-3">Mis Artículos</span>
                ...
                @if (addon_is_activated('club_point'))
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{ route('earnng_point_for_user') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3">Pieza Puntos Ganados</span>
