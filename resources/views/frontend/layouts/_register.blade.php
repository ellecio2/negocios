<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ static_asset('assets/registrocomercio/registro-form/assets/css/theme-2.css') }}">
        @yield('styles')
        <!-- Fonts -->
        ...
        <script src='https://maps.google.com/maps/api/js?libraries=places&region=uk&language=en&sensor=true&key={{ env('GOOGLE_MAPS_API_KEY') }}' async></script>
        ...
        <div class="ugf-wrapper theme-bg">
            <div class="ugf-content-block">
                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-lg-3 p-sm-0">
                            <div class="ugf-content pt150">
                                <a href="{{ route('shop.view.account.type') }}" class="prev-page"> <i class="las la-arrow-left" ></i> Atrás</a>
                                <h3 class="margin-bc">Bienvenido!<span style="font-size: 2.3rem;">Registra tu @yield('register-type')</span></h3>
                ...
                <div class="alternet-access">
                    <p style="font-size: 1.5rem; font-weight: bold;">Ya tienes una cuenta?<a href="{{ route('user.login') }}">&nbsp; Entra aqui!</a></p>
                </div>
            </div>
