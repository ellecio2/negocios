<div class="modal-body px-4 py-5 c-scrollbar-light">
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="row gutters-1010 flex-row-reverse">
                @php
        ...
        <div class="col-lg-6">
            <div class="text-left">
                            ...
                            @foreach (json_decode($product->choice_options) as $key => $choice)
                                <div class="row no-gutters mt-3">
                                    <div class="col-3">
                                        {{--
                                            <div
                                                class="text-secondary fs-14 fw-400 mt-2 ">{{ get_single_attribute_name($choice->attribute_id) }}
                                            </div>
                                        --}}
                                    </div>
                                    <div class="col-9">
                ...
                <div class="mt-3">
                    @if ($product->digital == 1)
                        <button type="button" class="btn btn-primary rounded-25px buy-now fw-600 add-to-cart"
                                onclick="addToCart()">
                    ...
                    @elseif($qty > 0)
                        <button type="button" class="btn btn-primary rounded-25px buy-now fw-600 add-to-cart"
                                style="width: 100%;" onclick="addToCart()">
                            <i class="la la-shopping-cart"></i>
                            <span class="d-none d-md-inline-block">{{ translate('Add to cart')}}</span>
                        </button>
                    @endif
                    <button type="button" class="btn btn-secondary rounded-25px out-of-stock fw-600 d-none" disabled>
