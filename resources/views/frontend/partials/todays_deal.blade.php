    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            @if (get_setting('todays_deal_banner') != null || get_setting('todays_deal_banner_small') != null)
                <div class="overflow-hidden d-none d-md-block bg-lapieza" style="border-radius: 15px 15px 0 0;">
            ...
            @endif
            <!-- Products -->
            <div class="" style="background-color: #003b73; border-radius: 0 0 15px 15px;">
                            ...
                            @foreach ($todays_deal_products as $key => $product)
                                <div class="carousel-box h-100 px-3 px-lg-0">
                                    <a href="{{ route('product', $product->slug) }}"
                                        ...
                                        <!-- Image -->
                                        <div
                                            class="img h-130px w-130px rounded-content-lapieza overflow-hidden mx-auto">
                                            <img class="lazyload img-fit-pieza m-auto has-transition"
