@php use App\Models\ManualPaymentMethod; @endphp
...
@section('panel_content')
    ...
    @php
        $storeAddress = $order->shop->user->addresses()->default()->first();
    @endphp
        <!-- Order Summary -->
    <div class="card rounded-15p shadow-none border mb-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <table class="table-borderless table">
                        ...
                        <tr>
                            <td class="w-50 fw-600">{{ translate('NCF') }}:</td>
                            <td class="">{{ auth()->user()->type_ncf.''.str_pad($order->ncf_id, 8, '0', STR_PAD_LEFT) }}</td>
                        </tr>
                        <tr>
                            <td class="w-50 fw-600">{{ translate('Customer') }}:</td>
                            <td>{{ json_decode($order->shipping_address)->name ?? $order->user->name}}</td>
                        </tr>
                        <tr>
                ...
                <div class="col-lg-6">
                    <table class="table-borderless table">
                        ...
                        <tr>
                            ...
                            <td>{{ $order->formated_shipping_type }}</td>
                        </tr>
                        <tr>
                            <td class="w-50 fw-600">{{ translate('Payment method') }}:</td>
                            @if($order->manual_payment)
                                <td>{{ ManualPaymentMethod::find(ltrim(strrchr($order->payment_type, "_"), "_"))->heading }}</td>
                            @else
    ...
    <div class="row gutters-16">
        <div class="col-md-9">
            <div class="card rounded-15p shadow-none border mt-2 mb-4">
                <div class="card-header border-bottom-0">
        ...
        <!-- Order Ammount -->
        <div class="col-md-3">
            <div class="card rounded-15p shadow-none border mt-2">
                <div class="card-header border-bottom-0">
