...
@section('panel_content')
    ...
    <div class="row gutters-16">
        ...
        <div class="col mb-4">
            ...
            <div class="h-100">
                ...
                <div
                    class="row h-100 @if (get_setting('wallet_system') != 1 && addon_is_activated('club_point')) row-cols-md-2 @endif row-cols-1">

                    <!-- Expenditure summary -->

                    <div class="col">

                        <div class="p-4 bg-primary rounded-15p @if (!addon_is_activated('club_point')) h-100 @endif"
                            ...
                            <div class="d-flex align-items-center pb-4 ">
                                ...
                                <div class="ml-3 d-flex flex-column justify-content-between">
                                    ...
                                    <span
                                        class="fs-14 fw-400 text-white mb-1">{{ translate('Total Expenditure') }}</span>
                    ...
                    @if (addon_is_activated('club_point'))
                        ...
                        <div class="col">
                            ...
                            <div class="p-4 bg-warning  rounded-15p">
                                ...
                                <div class="d-flex align-items-center pb-4 ">
                                    ...
                                    <div class="ml-3 d-flex flex-column justify-content-between">
                                        ...
                                        <span class="fs-14 fw-400 text-white mb-1">Total Pieza Puntos</span>
    ...
    <div class="row gutters-16 mt-2">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            ...
            <div class="px-4 bg-white border h-100 rounded-15p">
        ...
        @if (false)
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                ...
                <div class="p-4 border h-100 rounded-15p">
                ...
                @if (Auth::user()->addresses != null)
                    ...
                    @if ($address != null)
                        ...
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->postal_code }} - {{ $address->city }},</span>
                            </li>

                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->state }},</span></li>

                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->country }}.</span></li>
    ...
    @else
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="text-center bg-white p-4 border rounded-15p">
