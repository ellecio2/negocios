                                    ...
                                    <div class="media">
                                        <span class="avatar avatar-sm flex-shrink-0 border">
                                            @if (Auth::user()->id == $conversation->sender_id)
                                                ...
                                                @endif
                                            @else
                                                <img @if ($conversation->sender->avatar_original == null) src="{{ static_asset('assets/img/avatar-place.png') }}" @else src="{{ uploaded_asset($conversation->sender->avatar_original) }}" @endif
