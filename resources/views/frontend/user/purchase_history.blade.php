                                ...
                                <td class="text-right pr-0">
                                    ...
                                    @if ($order->delivery_status == 'pending' && $order->payment_status == 'unpaid')
                                        <a href="javascript:void(0)"
                                            class="btn btn-soft-danger btn-icon btn-circle btn-sm hov-svg-white mt-2 mt-sm-0 confirm-delete"
                                    ...
                                    <!-- Invoice -->
                                    <a class="btn btn-soft-warning btn-icon btn-circle btn-sm hov-svg-white mt-2 mt-sm-0"
