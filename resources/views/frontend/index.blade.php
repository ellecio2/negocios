...
@section('content')
    <div class="home-banner-area mb-3" style="margin-right: 30px;">
        <div class="container">
            <div class="d-flex flex-wrap position-relative ">
                @if (get_setting('home_banner1_images') != null)
                    <div class="mb-2 mb-md-3 mt-2 mt-md-3">
                        <div class="container">
                            <div class="home-slider-lapieza rounded-15px">
                                        ...
                                        @foreach ($slider_images as $key => $value)
                                            <div class="carousel-box">
                                                <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                                    <!-- Image -->
                                                    <img
                                                        class="d-block mw-100 img-fit h-sm-auto h-md-320px h-lg-460px overflow-hidden rounded-15px"
    ...
    @if (get_setting('home_banner3_images') != null)
        <div class="mb-2 mb-md-3 mt-2 mt-md-3 carrusel">
            <div class="container">
                @php
                    ...
                    <div>
                        <div class="text-dark d-flex align-items-center mb-0">
                            <a href="{{ route('flash-deals') }}"
                               class="fs-10 fs-md-12 fw-700 text-negro has-transition hov-opacity-100 hov-text-primary animate-underline-primary mr-3">{{ translate('View All Flash Sale') }}</a>
                            <span class=" border-left border-soft-light border-width-2 pl-3">
                                <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                                   class="fs-10 fs-md-12 fw-700 text-negro has-transition hov-opacity-100 hov-text-primary animate-underline-primary">{{ translate('View All Products from This Flash Sale') }}</a>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gutters-5 gutters-md-16">
                    ...
                    <div class="col-xxl-4 col-lg-5 col-6 h-200px h-md-400px h-lg-475px">
                        <div class="h-100 w-100 w-xl-auto"
                             style="background-image: url('{{ uploaded_asset($flash_deal->banner) }}'); background-size: cover; background-position: center center; border-radius: 15px;">
                    ...
                    <div class="col-xxl-8 col-lg-7 col-6">
                        ...
                        @endphp
                        <div
                            class="aiz-carousel border-top @if (count($flash_deals) > 8) border-right @endif arrow-inactive-none arrow-x-0 br-banner"
            ...
            <div class="container">
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <!-- Links -->
                        <div class="d-flex">
                            <a class="text-negro fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary"
                ...
                <div class="bg-white px-sm-3">
                    <div class="aiz-carousel sm-gutters-17" data-items="8" data-xxl-items="8" data-xl-items="6"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            <div
                                class="br-best-selling carousel-box position-relative text-center has-transition hov-scale-img">
                                <a href="{{ route('products.category', $category->slug) }}" class="d-block ">
                                    <img src="{{ uploaded_asset($category->banner) }}"
                                         class="lazyload h-150px mx-auto has-transition mw-100 rounded-15px"
    ...
    @endif
    <!-- ESTA ES LA SECCION PARA MOSTRAR LOS TALLERES -->
    <!-- ESTA ES LA SECCION PARA MOSTRAR LOS TALLERES -->
    <!-- New Products -->
    ...
    @if (get_setting('coupon_system') == 1)
        <div class="mb-2 mb-md-3 mt-2 mt-md-3" style="background-color: #C3E2FF;">
            <div class="container">
                <div class="row py-5">
                        ...
                        <div class="d-lg-flex">
                            <div class="mb-3 mb-lg-0">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="169.602" height="153.34" viewBox="0 0 109.602 93.34">
                                    <defs>
                            ...
                            <div class="ml-lg-3">
                                <h5 class="fs-36 fw-400 text-black mb-3">
                                    <b>{{ translate(get_setting('cupon_title')) }}</b></h5>
                                <h5 class="fs-20 fw-400 text-black">
                                    <em>{{ translate(get_setting('cupon_subtitle')) }}</em></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 text-center text-xl-right mt-4">
                        <a href="{{ route('coupons.all') }}"
                           ...
                           style="border-color: #003b73; border-radius: 15px;background: #003b73;">{{ translate('View All Coupons') }}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @endif
    @if (get_setting('home_banner3_images') != null)
        <div class="mb-2 mb-md-3 mt-2 mt-md-3 carrusel-hide">
            <div class="container">
                @php
                    $banner_3_imags = json_decode(get_setting('home_banner3_images'));
                    $data_md = count($banner_3_imags) >= 2 ? 2 : 1;
            ...
            <div class="container">
                ...
                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                    ...
                    @foreach ($best_selers as $key => $seller)
                        @if ($seller->user != null)
                            <div
                                class="br-best-selling carousel-box h-100 position-relative text-center border-right border-top border-bottom @if ($key == 0) border-left @endif has-transition hov-animate-outline-lapieza">
                                                        ...
                                                        <g id="Group_25927" data-name="Group 25927"
                                                           transform="translate(480 345)">
                                                            <path id="Union_5" data-name="Union 5"
                                                                  ...
                                                                  transform="translate(0 0)" fill="#41FF35"/>
                                                        </g>
                                                    </g>
                                                </svg>
                                            @else
...
@section('script')
    <script>
        $(document).ready(function () {
            $.post('{{ route('home.section.articles') }}', {
                _token: '{{ csrf_token() }}'
            }, function (data) {
                $('#section_articles').html(data);
