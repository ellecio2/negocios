                    ...
                    @foreach ($assigned_deliveries as $key => $delivery)
                        <tr>
                            ...
                            <td class="pl-0" style="vertical-align: middle;">
                                <a
                                    href="{{ route('delivery-boy.order-detail', encrypt($delivery->id)) }}">{{ $delivery->code }}</a>
                            </td>
                            <!-- Date -->
                            ...
                            <!-- Amount -->
                            <td class="fw-700" style="vertical-align: middle;">{{ single_price($delivery->grand_total) }}
                            </td>
                            <!-- Delivery Status -->
                            ...
                            <td class="text-right pr-0 w-130px" style="vertical-align: middle;">
                                <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm"
                                    onclick="confirm_cancel_request('{{ route('cancel-request', $delivery->id) }}')"
                                    title="{{ translate('Cancel') }}">
                                    <i class="las la-times"></i>
                                </a>
                                <a href="{{ route('delivery-boy.order-detail', encrypt($delivery->id)) }}"
                                ...
                                <a class="btn btn-soft-warning btn-icon btn-circle btn-sm"
                                    href="{{ route('invoice.download', $delivery->id) }}"
