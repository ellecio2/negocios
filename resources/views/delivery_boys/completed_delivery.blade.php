                        ...
                        @if (optional($delivery->order)->code)
                            <tr>
                                ...
                                <td class="pl-0" style="vertical-align: middle;">
                                    <a
                                        href="{{ route('delivery-boy.order-detail', encrypt($delivery->order->id)) }}">{{ $delivery->order->code }}</a>
                                </td>
                                <!-- Date -->
                                ...
                                <td class="text-right pr-0" style="vertical-align: middle;">
                                    <a href="{{ route('delivery-boy.order-detail', encrypt($delivery->order->id)) }}"
                                    ...
                                    <a class="btn btn-soft-warning btn-icon btn-circle btn-sm"
                                        href="{{ route('invoice.download', $delivery->order->id) }}"
