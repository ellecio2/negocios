        ...
        <div class="card-body">
            <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="password" class="form-control rounded-15p"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control rounded-15p mb-3" placeholder="{{ translate('Your Address') }}" rows="3"
                ...
                <div class="form-group mb-0 text-right">
                    <button type="submit"
                        class="btn btn-primary rounded-25px w-200px">{{ translate('Update Profile') }}</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" class="form-control" style="border-radius:  15px 0 0 15px ;"
                        ...
                        <div class="form-group mb-0 text-right">
                            <button type="submit"
                                class="btn btn-primary rounded-25px w-250px">{{ translate('Update Email') }}</button>
                        </div>
                    </div>
                </div>
            </form>
