                    ...
                    @foreach ($today_collections as $key => $collection)
                        <tr>
                            ...
                            <td class="pl-0" style="vertical-align: middle;">
                                <a
                                    href="{{ route('delivery-boy.order-detail', encrypt($collection->order->id)) }}">{{ $collection->order->code }}</a>
                            </td>
                            <!-- Date -->
                            ...
                            <td class="text-right pr-0" style="vertical-align: middle;">
                                <a href="{{ route('delivery-boy.order-detail', encrypt($collection->order->id)) }}"
                                ...
                                <a class="btn btn-soft-warning btn-icon btn-circle btn-sm"
                                    href="{{ route('invoice.download', $collection->order->id) }}"
