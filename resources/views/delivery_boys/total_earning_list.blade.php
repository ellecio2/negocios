                    ...
                    @foreach ($total_earnings as $key => $earning)
                        <tr>
                            ...
                            <td class="pl-0" style="vertical-align: middle;">
                                <a
                                    href="{{ route('delivery-boy.order-detail', encrypt($earning->order->id)) }}">{{ $earning->order->code }}</a>
                            </td>
                            <!-- Date -->
                            ...
                            <td class="text-right pr-0" style="vertical-align: middle;">
                                <a href="{{ route('delivery-boy.order-detail', encrypt($earning->order->id)) }}"
                                ...
                                <a class="btn btn-soft-warning btn-icon btn-circle btn-sm"
                                    href="{{ route('invoice.download', $earning->order->id) }}"
