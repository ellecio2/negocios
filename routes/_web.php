...
// esto es para mostrar los articulos del usuario com el vehiculo y demas.
Route::get('articles', [ArticlesController::class, 'index'])->name('articles.index');
Route::get('add_articles_modal', [ArticlesController::class, 'addArticlesModal'])->name('add_articles_modal');
