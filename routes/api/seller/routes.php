...
Route::group(['prefix' => 'v2/seller', 'middleware' => ['app_language', 'auth:sanctum']], function () {
    Route::middleware(['auth:sanctum'])->group(function () {
        ...
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::get('products/{attribute_id}/attribute-values', 'getAttributesFromId');
        ...
        Route::controller(PosController::class)->group(function () {
            ...
            Route::post('pos/create-user', 'createUser');
            Route::put('pos/store/shipping/address', 'updateShippingAddress');
        });
    });
