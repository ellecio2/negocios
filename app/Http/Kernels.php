...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'meta-validate' => \App\Http\Middleware\MetaTokenMiddleware::class,
        'pedidosya-validate' => \App\Http\Middleware\PedidosYaTokenMiddleware::class,
        'hasItemsInCart' => \App\Http\Middleware\CheckCartNotEmptyMiddleware::class,
        'temporary-password-check' => \App\Http\Middleware\TemporaryPasswordMiddleware::class,
        'wallet' => \App\Http\Middleware\WalletMiddleware::class,
        'phone-verified' => \App\Http\Middleware\PhoneVerifiedMiddleware::class
    ];
