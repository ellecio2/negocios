                ...
                if (!empty($shop_items_raw_data)) {
                    foreach ($shop_items_raw_data as $shop_items_raw_data_item) {
                        ...
                        $shop_items_data[] = $shop_items_data_item;
                             $cartId[] = $shop_items_data_item["id"];
                    }
                }
...
//     $total_quantity = $cart ? $cart->quantity + $quantity : $quantity;
//     if ($product_stock->qty < $total_quantity) {
//         return response()->json([
//             'result' => false,
//             'message' => translate('Requested quantity is not available in stock.')
//         ], 400);
//     }
//
...
//     }
//
//     // Calculate price and tax for a single item
//     $single_price = CartUtility::get_price($product, $product_stock, 1);
//     $single_tax = CartUtility::tax_calculation($product, $single_price);
//
//     // Calculate total price and tax based on quantity
//     $total_price = $single_price * $total_quantity;
//     $total_tax = $single_tax * $total_quantity;
//
//     // Save or update cart
//     CartUtility::save_cart_data($cart, $product, $total_price, $total_tax, $total_quantity);
//
//     return response()->json([
//         'result' => true,
...
// }
    ...
    public function add(Request $request)
    {
        ...
        // Validar stock antes de cualquier otra lógica
